...
par(mar=c(1, .1, 1, .1))
par(mfrow = c(1, 3))
persp(J, A, z1, theta = theta0, phi=phi0, col="lightgray", zlab="phi")
persp(J, A, z2, theta = theta0, phi=phi0, col="lightgray", zlab="phi")
persp(J, A, z3, theta = theta0, phi=phi0, col="lightgray", zlab="phi")
par(mfrow = c(1, 1))
```
...
There is a numerical artifact (the vertical line) joining the branch of stable trivial equilibrium points 
and the branch of stable positive equilibrium points. The bifurcation to positive equilibrium points that takes place 
at $\nu=1$ is to unstable equilibrium points, and our code does not yield  
unstable equilibrium points. This continuum of equilibrium points joints  $\, (1,0)$ and the point were the vertical line ends. At this point, a blue sky type bifurcation 
...
persp(mu, alpha, k3d, theta = theta0, phi=phi0, ticktype = "detailed", zlab = "kappa")
...
persp(mu, alpha, k3d2, theta = theta0, phi=phi0, ticktype = "detailed", zlab = "kappa")
```
...
Producing Figure 8 in the manuscript requiers of aslightly different definition 
